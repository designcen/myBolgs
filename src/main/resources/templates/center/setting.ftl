    ...
    <div class="fly-panel fly-panel-user" pad20>
        <div class="layui-tab layui-tab-brief" lay-filter="user">
            ...
            <div class="layui-tab-content" style="padding: 20px 0;">
                    ...
                    <form method="post">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="L_email" name="email" required lay-verify="email" autocomplete="off" value="${user.email}" class="layui-input" disabled>
                            </div>
                        ...
                        <div class="layui-form-item layui-form-text">
                            ...
                            <div class="layui-input-block">
                                <textarea placeholder="随便写些什么刷下存在感" id="L_sign"  name="sign" autocomplete="off" class="layui-textarea" style="height: 80px;">${user.sign?default('')}</textarea>
                            </div>
                        </div>
                        <div class="layui-form-item">
                ...
                <div class="layui-form layui-form-pane layui-tab-item">
                    <form action="${base}/center/repass" method="post">
                        <div class="layui-form-item">
